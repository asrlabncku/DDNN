...
#fn = "{}/chain_snapshot_epoch_{:06}".format(path,epoch)
        ...
        fn = "models/test_cifar10/cifar10_64f_nb_good2/chain_snapshot_epoch_000080"
...
#print("Gen Code Over ! ")
    ...
    def __call__(self,message): 
        ...
        if int(layer_number) == 0 :
            result = chain.con_evaluate_raw( data_string , layer_number )
        else : 
