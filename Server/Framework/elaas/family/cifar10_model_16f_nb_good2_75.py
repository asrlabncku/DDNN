...
class Cifar10_16f_nb_good2_75:
    ...
    def __init__(self):
        ...
        nfilters_embeded = int(16)
        nlayers_embeded = int(1)
        nfilters_cloud = int(16)
        nlayers_cloud = int(4)
        branchweight = float(0.1)
        lr = numpy.float64(0.001)
        nepochs = int(80)
        ent_T = numpy.float64(0.75)
        name = str("cifar10_16f_nb_good2_75")
...
#fn = "{}/chain_snapshot_epoch_{:06}".format(path,epoch)
        ...
        fn = "models/test_cifar10/cifar10_16f_nb_good2_75/epoch_000080"
