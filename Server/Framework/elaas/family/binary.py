...
class BinaryFamily:
    def __init__(self, folder="_models/binary", prefix=None, input_dims=1, output_dims=10):
        self.folder = folder
        self.prefix = prefix
    ...
    def setup_chain_model(self, **kwargs):
        ...
        #print(type(branchweight))
        #print(type(lr))
        #print('test branchweight value : ' , branchweight)
        #print('test lr value : ' , lr)
