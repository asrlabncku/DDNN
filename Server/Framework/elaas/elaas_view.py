...
class Collection(object):
    def __init__(self, name="collection", path="_models", nepochs=10, verbose=True):
    ...
    def train(self, niters=1, bootstrap_nepochs=1):
        ...
        for point in do.get_bootstrap_points(bootstrap_nepochs):
            ...
            if result.get('main/branch0exit') is not None and point.get("target_branch0exit") is not None:
                ...
                print "result[main/branch0exit]:%s , point[targe_branch0exit]:%s" % (type(result.get('main/branch0exit')),type(point.get("target_branch0exit")))
            meta = {}
        ...
        while i < niters:
            ...
            print "Do NO%d. iterator evaluate " % (i)
            result = trainer.evaluate()
